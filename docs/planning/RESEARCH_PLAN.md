...
|---|---|---|---|
| B1e design on the 8B (`b1e_footprint.py --model failspy/...`; replication of PREREG_B1e) | `sb-202c42d30b800e74` (box 6) | footprint-matched control on a second model | ✅ complete 11:58Z (report 30, `b1e8.*`): H3; permdir 0.96× and inert; sad 36% (q 0.002), afraid 14% (q 0.08) |
