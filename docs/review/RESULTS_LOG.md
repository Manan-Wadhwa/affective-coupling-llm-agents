...
`b1c_alllayer_llama3-abl.json`: five of six emotions transfer (same five as the 27B); afraid 15% and sad 31% blocked by the rank-1 direction vs random; MC-ablate fails 4/6 because the 6–20 and 6–31 windows give identical readouts (a tie on ≥). Registry `b1c8.*` (2); report 29.
