...
sys.path.append('/tmp/p1')   # sandbox deploy dir; appended, not prepended,
                             # so it cannot shadow local modules
...
ap.add_argument("--reps", type=int, default=8); ap.add_argument("--outdir", default="results/behavioral")
a = ap.parse_args()
